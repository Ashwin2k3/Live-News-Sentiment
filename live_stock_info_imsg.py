...
def send_imessage(recipient, stock_ticker, news_title, news_description, news_sentiment, market_sentiment, news_url):
            ...
            if texts:
                ...
                if new_signal != last_signal:
                    ...
                    for article in articles:
                        ...
                        send_imessage(recipient, stock_ticker, title, description, news_sentiment, market_sentiment, url)
